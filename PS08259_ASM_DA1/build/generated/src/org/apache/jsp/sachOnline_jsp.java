...
public final class sachOnline_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for (NhaXB n : nxb1) {
      ...
      out.write("                </li>\n");
      out.write("            </ul>\n");
      out.write("            <form action=\"seachSachOnline.jsp\">\n");
...
for (Sach s : sach) {
                    if (!s.getFiles().equals("")) {
                        ...
                        out.println("<div class=\"boxbook\">"
                                ...
                                + "<hr>"
                                + "<div class=\"loai\">Thể loại: " + s.getLoai() + "</div>"
                                + "<hr>"
